...
public class NostroNegativeBalanceController {

    private final NostroNegativeBalanceService service;

    private static final Logger logger = LogManager.getLogger(NostroNegativeBalanceController.class);

    public NostroNegativeBalanceController(NostroNegativeBalanceService service) {
        this.service = service;
    }

    @PostMapping("/negative-balance")
    public ResponseEntity<?> getNegativeBalanceReport(
        ...
        try {
            ...
            Page<NostroNegativeBalanceProjection> result = service.getNegativeBalances(filter, pageable);
