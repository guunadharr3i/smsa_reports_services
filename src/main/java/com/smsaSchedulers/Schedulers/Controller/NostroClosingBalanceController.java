...
public class NostroClosingBalanceController {

    private final NostroClosingBalanceService service;

    private static final Logger logger = LogManager.getLogger(NostroClosingBalanceController.class);

    public NostroClosingBalanceController(NostroClosingBalanceService service) {
    ...
    public ResponseEntity<?> getClosingBalance(
        ...
        try {
            ...
            Page<NostroClosingBalanceProjection> result = service.getClosingBalances(filter, pageable);
